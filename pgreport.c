...
main(int argc, char **argv)
{
  ...
  fetch_table(XIDWRAPAROUNDURGENCY_TITLE, XIDWRAPAROUNDURGENCY_SQL);
  fetch_table(MXIDWRAPAROUNDURGENCY_TITLE, MXIDWRAPAROUNDURGENCY_SQL);
  ...
  fetch_table(ATTRIBUTES_TITLE, ATTRIBUTES_SQL);
  ...
  fetch_table(TABLEWITHOUTPKEY_TITLE, TABLEWITHOUTPKEY_SQL);
  fetch_table(BAD_DATATYPE_TITLE, BAD_DATATYPE_SQL);
  fetch_table(RLS_TITLE, RLS_SQL);
  fetch_table(POLICY_TITLE, POLICY_SQL);
  fetch_table(PARTITIONGLOBALSIZE_TITLE, PARTITIONGLOBALSIZE_SQL);
  fetch_table(PARTITIONLIST_TITLE, PARTITIONLIST_SQL);
  ...
  if (backend_minimum_version(10,0))
  {
    fetch_table(SEQUENCEEXHAUSTION_TITLE, SEQUENCEEXHAUSTION_SQL);
  }
  ...
  fetch_table(VACUUMURGENCY_TITLE, VACUUMURGENCY_SQL);
  fetch_table(ANALYZEURGENCY_TITLE, ANALYZEURGENCY_SQL);
  fetch_table(VISIBILITYMAPURGENCY_TITLE, VISIBILITYMAPURGENCY_SQL);
  ...
  /*
  fetch_table(PGSTATSTATEMENTSINFO_TITLE, PGSTATSTATEMENTSINFO_SQL);
